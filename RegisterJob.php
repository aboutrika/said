...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['facultyName']) && isset($_POST['facultyEmail']) && isset($_POST['facultyDesignation']) && isset($_POST['supervisingQuota']) && isset($_POST['emailSend'])){
        ...
        $email = filter_input(INPUT_POST,'jobEmail',FILTER_SANITIZE_EMAIL);
        $design = filter_input(INPUT_POST,'jobDesignation',FILTER_SANITIZE_SPECIAL_CHARS);
        $contact = filter_input(INPUT_POST,'jobContact',FILTER_SANITIZE_NUMBER_INT);
        $quota = filter_input(INPUT_POST,'supervisingQuota',FILTER_SANITIZE_NUMBER_INT);
        $password = filter_input(INPUT_POST,'jobPassword',FILTER_SANITIZE_SPECIAL_CHARS);
